...
function PageNotFound() {
  return (
    ...
    <div class="block md:max-w-lg">
        <image src="/images/illustrations/404.svg" alt="astronaut image"/>
    </div>
    <div class="text-center xl:max-w-4xl">
        <h1 class="mb-3 text-2xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">Page not found</h1>
