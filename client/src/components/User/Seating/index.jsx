    ...
    return (
      ...
      >
        <div className="seatingModal__nav">
          <div>
            <div>
              <h4 style={{ color: "white", fontSize: 20 }}>{movieInformation.title}</h4>
              <h5 style={{ color: "white" }}>{movieInformation.cinemas_name}</h5>
            </div>
            <div>
          ...
          <div>
            <h3>{movieInformation.startDate} {monthNames[new Date().getMonth()]} {movieInformation.Duration}</h3>
          </div>
        </div>
