...
import { getTheaterMovies } from "../../../redux/actions/movieAction"
...
React.useEffect(() => {
    ...
    return (
        <div className={styles.container}>
                ...
                <div>
                    <div className={styles.header}>
                        <div onClick={() => SetLanguage(!language)}>
                            ...
                            {language && <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 10"><path fill="none" stroke="#FF1203" stroke-width="1.5" d="M335 3L342 9.5 335 16" transform="matrix(0 -1 -1 0 17 344)"></path></svg>}
                            <span style={{ marginLeft: '10px', color: `${!language ? 'white' : '#FF1203'}` }}>Languages</span>
                        </div>
                        <div onClick={() => handleClear("languages")}>Clear</div>
                    </div>
                    <div className={styles.dialogue} style={language ? { display: 'flex' } : { display: 'none' }}>
                        <button style={filterLanguage.includes('Hindi') ? {background:'#FF1203', border:'none', color:'white'}:{}} onClick={() => handleFilter("Hindi", "", "")}>Hindi</button>
                        <button style={filterLanguage.includes('English') ? {background:'#FF1203', border:'none', color:'white'}:{}} onClick={() => handleFilter("English", "", "")}>English</button>
                        <button style={filterLanguage.includes('Telugu') ? {background:'#FF1203', border:'none', color:'white'}:{}} onClick={() => handleFilter("Telugu","","")}>Telugu</button>
                        <button style={filterLanguage.includes('Kannada') ? {background:'#FF1203', border:'none', color:'white'}:{}} onClick={() => handleFilter("Kannada")}>Kannada</button>
                        <button style={filterLanguage.includes('Japaniese') ? {background:'#FF1203', border:'none', color:'white'}:{}} onClick={() => handleFilter("Japaniese", "", "")}>Japaniese</button>
                        <button style={filterLanguage.includes('Malayalam') ? {background:'#FF1203', border:'none', color:'white'}:{}} onClick={() => handleFilter("Malayalam")}>Malayalam</button>
                        <button style={filterLanguage.includes('Punjabi') ? {background:'#FF1203', border:'none', color:'white'}:{}} onClick={() => handleFilter("Punjabi", "", "")}>Punjabi</button>
                    </div>
                </div>
            ...
            <div>
                <h2 style={{ background: 'none', fontSize: '25px', fontWeight: '700', marginLeft: '30px' }}>Movies in </h2>
                ...
                <div className={styles.mainCards}>
                    {(filterMovie.length === 0) ? <div style={{
